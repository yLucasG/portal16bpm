...
export const SERVICES: ServiceDef[] = [
  {
    ...
    checklistItems: [
      ...
      { id: 'oo-4', label: 'Checar comunicações e frequências de rádio', category: 'Início do Serviço' },
      { id: 'oo-5', label: 'Confirmar armamento e munição da guarda', category: 'Segurança' },
      { id: 'oo-6', label: 'Checar equipamentos de primeiros socorros', category: 'Segurança' },
  ...
  },
  {
    ...
    checklistItems: [
      ...
      { id: 'fd-4', label: 'Inspecionar alojamentos e dependências', category: 'Instalações' },
      { id: 'fd-5', label: 'Verificar o estado geral das instalações', category: 'Instalações' },
      { id: 'fd-6', label: 'Coordenar limpeza e organização das dependências', category: 'Instalações' },
      { id: 'fd-7', label: 'Controlar entrada e saída de pessoal', category: 'Controle' },
      { id: 'fd-8', label: 'Conferir documentos administrativos do dia', category: 'Controle' },
      { id: 'fd-9', label: 'Verificar armamento e munição no paiol', category: 'Segurança' },
      { id: 'fd-10', label: 'Registrar ocorrências no livro de protocolo', category: 'Registro' },
      { id: 'fd-11', label: 'Encaminhar relatório diário ao Comandante', category: 'Encerramento' },
      { id: 'fd-12', label: 'Lavrar termo de passagem de serviço', category: 'Encerramento' },
    ],
  },
];
